...
description: "Vamos criar um sistema de login usando Passport.js para a estratégia de autenticação e JSON Web Tokens (JWT) para gerar credenciais de acesso seguras."
---
...
Para orquestrar tudo isso, usaremos duas bibliotecas do ecossistema Nest.js:
