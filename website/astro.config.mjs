		...
		starlight({
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						{ label: 'Os 3 Pilares: Módulos, Controllers e Providers', link: '3-arquitetura-e-conceitos/1-os-tres-pilares' },
						{ label: 'Controllers: Lidando com Requisições', link: '3-arquitetura-e-conceitos/2-controllers-e-rotas' },
						{ label: 'Providers e Services: A Lógica de Negócio', link: '3-arquitetura-e-conceitos/3-providers-e-services' },
						{ label: 'Módulos: Organizando sua Aplicação', link: '3-arquitetura-e-conceitos/4-modulos-e-organizacao' },
